...
- mark#x,y,width#...
- imgr#x,y,width#...
- imgr#x,y,width,height#...
- imgb#x,y,width#...
- imgb#x,y,width,height#...

Image absolute-variant behavior:
- 3-value form (x,y,width): height is derived from source image aspect ratio.
- 4-value form (x,y,width,height): image is scaled proportionally to fit inside the target rectangle (may upscale or downscale), without overflow.
